...
class CaptchaComponent extends Component {
    ...
    function getCaptcha() {
        $this->controller->Session->write('cakecaptcha', $this->CreateImage());
    }
    ...
    protected function ImageAllocate() {
        ...
        for( $i = 0; $i < 10; $i++ )  {
            $lineStart = mt_rand( 0, 150 );
            $lineEnd = mt_rand( 0, 150 );
            imageline( $this->im, 0, $lineStart, 10020, $lineEnd, $color[1] * $color[0] * $color[2]);
        }
        
        for( $i = 0; $i < 3000; $i++ )  {
            $x = rand(0, 400);
            $y = rand(0,140);
            imagesetpixel($this->im, $x, $y, $color[1] * $color[0] * $color[2]);
        }
    ...
    protected function WriteText($text, $fontcfg = array()) {
        ...
        $fontSizefactor = 1.3 + ($lettersMissing * 0.09);
