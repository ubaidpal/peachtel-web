...
<div id="content">	
    ...
    <div class="container">
        <div class="grid-24">
            ...
            <div style="text-align: right;"><a href="<?php echo $this->base; ?>/users/support/open_ticket">&#43; Open New Ticket</a></div>
                    ...
                    <table class="table table-bordered table-striped data-table">
                        ...
                        if (!empty($userTickets)) :
                            foreach ($userTickets as $ticket): ?>
                                <tr class="gradeA">
                                    <td> <?php echo $this->requestAction(array('controller' => 'users', 'action' => 'getElapseTime', strtotime($ticket['Tblticket']['date'])))." Ago"; ?> </td>
                                    <td> <?php echo $ticket['Tblticketdepartment']['name'] ?> </td>
                                    <td> <a href="<?php echo $this->base; ?>/users/support/get_ticket/<?php echo $ticket['Tblticket']['id'] ?>"><?php echo (!empty($ticket['Tblticket']['name'])) ? "#".$ticket['Tblticket']['tid']." - ".$ticket['Tblticket']['name'] : "#".$ticket['Tblticket']['tid']." - ".$ticket['Tblticket']['status']; ?></a> </td>
                                    ...
                                    <td> <?php echo ($ticket['Tblticket']['lastreply'] != '0000-00-00 00:00:00') ? $this->requestAction(array('controller' => 'users', 'action' => 'getElapseTime', strtotime($ticket['Tblticket']['lastreply'])))." Ago" : 'No reply.'; ?> </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else : ?>
                            <tr class="gradeA">
