...
<select name="view">
    ...
    <option value=""<?php if ($this->_tpl_vars['ticketstatusfilter'] == ""): ?> selected<?php endif; ?>><?php echo $this->_tpl_vars['_ADMINLANG']['support']['awaitingreply']; ?>
 (<?php echo $this->_tpl_vars['ticketsawaitingreply']; ?>
)</option>
    <option value="flagged"<?php if ($this->_tpl_vars['ticketstatusfilter'] == 'flagged'): ?> selected<?php endif; ?>><?php echo $this->_tpl_vars['_ADMINLANG']['support']['flagged']; ?>
 (<?php echo $this->_tpl_vars['ticketsflagged']; ?>
)</option>
    <option value="active"<?php if ($this->_tpl_vars['ticketstatusfilter'] == 'active'): ?> selected<?php endif; ?>><?php echo $this->_tpl_vars['_ADMINLANG']['support']['allactive']; ?>
...
"<?php if ($this->_tpl_vars['status']['title'] == $this->_tpl_vars['ticketstatusfilter']): ?> selected<?php endif; ?>><?php echo $this->_tpl_vars['status']['title']; ?>
...
"<?php if ($this->_tpl_vars['dept']['id'] == $this->_tpl_vars['ticketdeptfilter']): ?> selected<?php endif; ?>><?php echo $this->_tpl_vars['dept']['name']; ?>
</option>
<?php endforeach; endif; unset($_from); ?>
</select>
<span class="header"><?php echo $this->_tpl_vars['_ADMINLANG']['support']['subjectmessage']; ?>
</span>
<input type="text" name="subject" value="<?php echo $this->_tpl_vars['ticketsubjectfilter']; ?>
" />
<span class="header"><?php echo $this->_tpl_vars['_ADMINLANG']['fields']['email']; ?>
</span>
<input type="text" name="email" value="<?php echo $this->_tpl_vars['ticketemailfilter']; ?>
" />
