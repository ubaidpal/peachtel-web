<?php /* Smarty version 2.6.26, created on 2012-12-06 02:32:26
         compiled from /var/www/clients/templates/default/clientareacontacts.tpl */ ?>
            ...
            <ul class="inputs-list">
                ...
                <li class="col2half">
                    <label class="checkbox">
                        ...
                        <span><?php echo $this->_tpl_vars['LANG']['subaccountpermsorders']; ?>
</span>
                    </label>
                </li>
            </ul>
            ...
            <ul class="inputs-list">
                <li>
                    <label class="full control-label">
                        ...
                        <span><?php echo $this->_tpl_vars['LANG']['clientareacontactsemailsgeneral']; ?>
</span>
                    </label>
                </li>
                <li>
                    <label class="full control-label">
                        ...
                        <span><?php echo $this->_tpl_vars['LANG']['clientareacontactsemailsproduct']; ?>
</span>
                    </label>
                </li>
                <li>
                    <label class="full control-label">
                        ...
                        <span><?php echo $this->_tpl_vars['LANG']['clientareacontactsemailsdomain']; ?>
</span>
                    </label>
                </li>
                <li>
                    <label class="full control-label">
                        ...
                        <span><?php echo $this->_tpl_vars['LANG']['clientareacontactsemailsinvoice']; ?>
</span>
                    </label>
                </li>
                <li>
                    <label class="full control-label">
                        ...
                        <span><?php echo $this->_tpl_vars['LANG']['clientareacontactsemailssupport']; ?>
</span>
                    </label>
                </li>
            </ul>
...
" />
    <input class="btn btn-danger" type="button" value="<?php echo $this->_tpl_vars['LANG']['clientareadeletecontact']; ?>
