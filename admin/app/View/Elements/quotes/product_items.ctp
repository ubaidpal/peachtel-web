                ...
                switch($category['QbAdminCategory']['displayType']) {
                    case "1":
                        ...
                        echo "<div id='datacenters'>"; ?>
                            <?php
                                $dataCenters = array(
                                    'ATL' => ' Atlanta, GA - Datacenter - $0.00',
                                    'MIA' => ' Miami, FL - Datacenter - $0.00',
                                    'NYC' => ' New York, NY - Datacenter - $0.00',
                                    'SEA' => ' Seattle, WA - Datacenter - $0.00'
                                );
                                $i = 0;
...
<div id="visitcheckout-link-holder">
    <!--<h1><a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/myaccount/users/trunking" id="configDID">ORDER TELEPHONE NUMBERS!</a></h1>-->
    <h1><a href="https://devweb.peachtel.net/itakishop">VISIT OUR STORE!</a></h1>
