...
<div id="content">	
    ...
    <div class="container">
        <div class="grid-24">
            <div style="text-align: right;"><a href="<?php echo $this->base; ?>/admintools/support">&laquo; View  Tickets</a></div>
            <div class="box">
                ...
                <div id="message-container">
                    <?php echo  $this->Form->create('admintool', array('action' => 'addReply')); ?>
                ...
                <div id="ticket-container">
                    ...
                    <div id="message-container">
                        ...
                        <hr />
                        <i style="font-weight: bold; font-size: 10px;">Last <?php echo $this->requestAction(array('controller' => 'admintools', 'action' => 'getElapseTime', strtotime($ticket['Tblticket']['date'])))." Ago"; ?></i>
                ...
                <div id="reply-holder">
                    ...
                    <div id="reply-container">
                        ...
                        <div id="message-container">
                            ...
                            <hr />
                            <i style="font-weight: bold; font-size: 10px;">Last <?php echo $this->requestAction(array('controller' => 'admintools', 'action' => 'getElapseTime', strtotime($reply['Tblticketreply']['date'])))." Ago"; ?></i>
                        </div>
                    </div>
                    <?php endforeach; ?>
                    <div id="paginator">
...
$(function(){
    $('#status').live('change', function() {
        ...
        var stat = $(this).val();
        var url = '../ticketUpdateStatus';
        var data = {tid: id, status: stat};
        ajaxQuery(url, data);
    });
    
    $('.submit input').live('click', function(e){
        var data = $('#admintoolAddReplyForm').serialize()
        var url = "../addReply";
        ajaxQuery(url, data);
    ...
    $('#subject a').live('click', function(){
        ...
        if($(this).attr('method') == 'edit') {
            ...
            if(isTrue) {
                ...
                if(globalData) {
                    if(type == 'ticket') {
                        window.location = "<?php echo $this->base; ?>/support";
                    } else {
    ...
    $('#paginator a').live('click', function() {
        ...
        var url = '../get_ticket/<?php echo $ticketId; ?>?page='+index[1];
        ajaxQuery(url, {});
