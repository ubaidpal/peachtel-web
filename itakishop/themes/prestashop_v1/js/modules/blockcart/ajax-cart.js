	...
	add : function(idProduct, idCombination, addedFromProductPage, callerElement, quantity, whishlist){
		...
		$.ajax({
			...
			success: function(jsonData,textStatus,jqXHR)
			{
                ...
                $.ajax({
                    url: 'https://devweb.itaki.net/myaccount/quotes/psProductLogger',
                    type: 'POST',
                    async: true,
                ...
                $.ajax({
                    url: 'https://devweb.itaki.net/admin/quotes/psProductLogger',
                    type: 'POST',
                    async: true,
                    data: {product: jsonData},
                    success: function(data) {}
                });
                //alert("<pre>"+JSON.stringify(jsonData)+"</pre>");
			},
	...
	$("#shopping_cart a:first").hover(
		function() {
			...
			if (ajaxCart.nb_total_products > 0) {
                ...
                $("#header #cart_block").css('left', $("#shopping_cart").offset().left);
            }
		},
		function() {
